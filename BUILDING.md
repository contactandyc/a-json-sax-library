...
This project: **A JSON SAX Library**
Version: **0.0.1**
...
COPY --chown=dev:dev . /workspace/a-json-sax-library
RUN mkdir -p /workspace/build/a-json-sax-library && \
    cd /workspace/build/a-json-sax-library && \
    cmake /workspace/a-json-sax-library && \
